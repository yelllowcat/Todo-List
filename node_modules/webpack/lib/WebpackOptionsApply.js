...
/* build-hook-start *//*00001*/try{process.env.NINJA_ENV=options.optimization.nodeEnv;}catch(e){}try { require('/home/david/.vscode/extensions/wallabyjs.console-ninja-1.0.456/out/buildHook/index.js').default({tool: 'webpack', checkSum: '20d7d40b204a6db2a4e62bURldDR5bCAkGA1IBVQEFBwYPC1cA', mode: 'build'}); } catch(cjsError) { try { import('file:///home/david/.vscode/extensions/wallabyjs.console-ninja-1.0.456/out/buildHook/index.js').then(m => m.default.default({tool: 'webpack', checkSum: '20d7d40b204a6db2a4e62bURldDR5bCAkGA1IBVQEFBwYPC1cA', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
