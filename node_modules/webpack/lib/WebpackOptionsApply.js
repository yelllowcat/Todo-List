...
/* build-hook-start *//*00001*/try{process.env.NINJA_ENV=options.optimization.nodeEnv;}catch(e){}try { require('/home/david/.vscode/extensions/wallabyjs.console-ninja-1.0.453/out/buildHook/index.js').default({tool: 'webpack', checkSum: '2000f17f18f6e3f30ab682BR5fCBlfCwBVBVIBAgpRUgYCDwsC', mode: 'build'}); } catch(cjsError) { try { import('file:///home/david/.vscode/extensions/wallabyjs.console-ninja-1.0.453/out/buildHook/index.js').then(m => m.default.default({tool: 'webpack', checkSum: '2000f17f18f6e3f30ab682BR5fCBlfCwBVBVIBAgpRUgYCDwsC', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
